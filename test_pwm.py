...
try:
    ...
    GPIO.setup(M1, GPIO.OUT)# set GPIO 25 as an output. You can use any GPIO port

    p = GPIO.PWM(M1,50)    # create an object p for PWM on port 25 at 50 Hertz
                        # you can have more than one of these, but they need
                        # different names for each port 
                        # e.g. p1, p2, motor, servo1 etc.

    p.start(100)        # duty cycle value can be 0.0 to 100.0%, floats are OK
